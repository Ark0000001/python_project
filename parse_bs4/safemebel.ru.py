...
def write_csv(data):
    with open('safemebel.csv', 'a',encoding='utf-8') as f:
        writer = csv.writer(f)
...
def main():
    ...
    pattern = 'https://surgut.safemebel.ru/catalog/shkafy_metallicheskie/?PAGEN_1={}'

    for i in range(1, konec(pattern)):
        url = pattern.format(str(i))
        get_page_data(get_html(url))

    pattern = 'https://surgut.safemebel.ru/catalog/seyfy/?PAGEN_1={}'
