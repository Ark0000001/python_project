...
def write_csv(data):
    with open('krasn_железная-мебель.csv', 'a',encoding='utf-8') as f:
        writer = csv.writer(f)
...
def main():
    ...
    pattern = 'https://xn--80aalwqglfe.xn----7sbenacbbl2bhik1tlb.xn--p1ai/catalog/metallicheskie-shkafy/?PAGEN_1={}'

    for i in range(1, konec(pattern)):
        url = pattern.format(str(i))
        get_page_data(get_html(url))

    pattern = 'https://xn--80aalwqglfe.xn----7sbenacbbl2bhik1tlb.xn--p1ai/catalog/seyfy/?PAGEN_1={}'
